...
## regression
reg_12a <- felm(ln_suicide_rate ~ treat + post + DiD|st|0|st, data = data_12a)
summary(reg_12a)
...
stargazer(reg_12a,
          ...
          type = "latex",
          notes.align = "l",
          notes = "\\parbox[t]{10cm}{Treatment variable is 1 
                   if the state introduced the unilateral divorce act in 1973,
...
## regression
reg_13b <- felm(ln_suicide_rate ~ lag_f| st + year_f |0|st, data = data_13b)
summary(reg_13b)
